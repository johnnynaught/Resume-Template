...
\documentclass[letter paper,20pt]{article}
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{{\LARGE Dayu (Johnny) Xue}} \\ 
  United States Permanent Resident \\
  Email:~~~~\href{mailto:}{xued@seas.upenn.edu} & \href{https://github.com/johnnyif}{Github: github.com/johnnyif}\\
  Mobile:~~~434-466-6224 & \href{https://xprilion.com}{Portfolio: xprilion.com} \\
\end{tabular*}
...
\section{~~Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Computer and Information Technology;  GPA: 7.27}{Aug 2022 - 2024}
